...
def address_get_location(address):
    ...
    #jPRAv0mZ52gDMHCUGrixx2DGnSv87u1Q使我们自己账号申请的ak。
    r=requests.get(url)
    result=r.json()
...
if __name__=="__main__":
    ...
    print(json_str)
    with open("./ZhiLianData/zhilian_data.json",'w',encoding='utf-8') as file:
        file.write(json_str)